...
We build the space on the mesh we set as first argument.

The argument *conformity = :H1* means that resulting interpolation space is a subset of continous shape functions.
