...
# ╔═╡ d73852a0-3b80-11ef-2ed1-f108b2d1ceeb
using Statistics, PlutoUI, Gridap, GridapGmsh

# ╔═╡ 8b571c92-2be3-4684-9005-fab98bb3baf4
mesh = GmshDiscreteModel("model1mesh.msh")

# ╔═╡ 1ffec1e1-06ea-470b-8539-81d28288090c
writevtk(mesh,"model1mesh")

# ╔═╡ ea01023f-3015-45f8-a30c-a4cf6038cc0f
md"""
$((PlutoUI.LocalResource("model1mesh.png")))
"""

# ╔═╡ 04230dac-dca0-41a8-8adf-e41e87e9fa7c
begin
	T_top = 11 # °C    -> Surface temperature
	Lambda = 3 # W/mk  -> Thermal conductivity of the soil
	q = 0.08   # W/m^2 -> Heat flow (at the bottom)
end

# ╔═╡ c733e3e7-711d-46b3-9341-ced00e355324
begin
	x_min = 0     # m
	x_max = 7000  # m
	y_min = 0     # m
...
# ╔═╡ 5b75d107-e210-47de-a81b-d79101ceb48c
md"""
Function Spaces
"""

# ╔═╡ bc0d9808-c2a4-4e20-a343-0e7cec922f1a
DRT = ReferenceFE(raviart_thomas, Float64, 2)
...
manifest_format = "2.0"
project_hash = "310d238a5a3cfcf9d531a3d6d42328dada8ccce5"
